...
export function WorkflowSection() {
  ...
  return (
    <section className="border-y border-frosted-blue-200 bg-frosted-blue-50 py-20" id="how-it-works">
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-4">
          {workflowStepKeys.map((stepKey, index) => (
            <article
              ...
              key={stepKey}
            >
              <div className="flex h-10 w-10 items-center justify-center rounded-md bg-bright-teal-blue-50 text-sm font-semibold text-bright-teal-blue-700">
                {index + 1}
              </div>
              <h3 className="mt-5 text-lg font-semibold text-deep-twilight-950">
